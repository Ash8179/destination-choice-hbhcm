...
# File paths
# =========================
JSON_PATH = "/Users/zhangwenyu/Desktop/NUSFYP/Stage 1/1.1 Define Origins and Destinations/Destinations/Data/json/onemap_historicsites.json"
...
for item in data["SrchResults"]:
    ...
    record = {
        # ---------- Group A ----------
        "poi_id": f"HS_{uuid.uuid4().hex[:8]}",
        "name": item.get("NAME"),
        "category": "leisure",
        "subtype": "historic_site",
...
print("Historic sites successfully added to destination table.")
print(f"Number of historic sites added: {len(df_new)}")
