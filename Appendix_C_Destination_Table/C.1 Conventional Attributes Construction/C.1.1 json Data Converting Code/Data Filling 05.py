...
# File paths
# =========================
JSON_PATH = "/Users/zhangwenyu/Desktop/NUSFYP/Stage 1/1.1 Define Origins and Destinations/Destinations/Data/json/onemap_nationalparks.json"
...
print("National parks successfully added to destination table.")
print(f"Number of parks added: {len(df_new)}")
